...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //this else will run if the given email does not exist 
        ...
        if ($pass == $cpass) {
            ...
            if($result){
                ...
                header("Location:/3_forum_website_project/index.php?signupsuccess=true");
    ...
    header("Location:/3_forum_website_project/index.php?signupsuccess=false&error=$showError");
}
